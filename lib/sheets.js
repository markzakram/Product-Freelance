...
export async function getOpenProjects() {
  try {
    ...
    const title =
      titles.find((t) => /juli.?proyek/i.test(t)) ||
      titles.find((t) => /det[ia]?l.*proyek/i.test(t)) ||
      titles.find((t) => /proyek/i.test(t) && !/master/i.test(t) && !/panduan/i.test(t)) ||
...
// ===========================================================================
//  DATASET 5 — PANDUAN / TATA CARA (tab "Panduan")  [public]
// ===========================================================================
...
export async function getPanduan() {
  try {
    ...
    // The "Panduan" tab lives in the project spreadsheet; try juli then master.
    for (const sid of [IDS.juli, IDS.master]) {
      try {
